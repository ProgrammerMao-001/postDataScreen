...
-- Records of postlist
-- ----------------------------
INSERT INTO `postlist` VALUES ('1728f2b6-f2c1-4796-85ae-52b3b35fc204', '123', '8-12K', '123', '', '1', '[1020000,2600432,120305]', '啊', 'd93bd661-de20-4ed5-8b81-b96473218382', '内蒙古自治区鄂尔多斯市乌审旗', '{\"lng\":108.893878,\"lat\":38.942229}', '101120000', '山东', '3', '2');
INSERT INTO `postlist` VALUES ('576afb4d-f19c-4037-83f9-668358a12b1b', '岗位名称', '薪资范围', '平均薪资：', '职位描述', '0', '[1010000,1000020,100101]', '企业名称', '14a4319f-8f04-4bd6-8e44-32054bf3fbb5', '吉林省吉林市船营区松江路65号吉林市人民政府', '{\"lng\":126.556056,\"lat\":43.843566}', '101060000', '吉林', '0', '0');
INSERT INTO `postlist` VALUES ('c834f1c9-e1b1-4c6f-b033-93b40418334a', '京东科技-产品经理（偏数据策略及分析）', '20-40K·16薪', '80K', '工作内容： \r\n1.搭建并完善基金全面、精细的数据监控体系，提升基金线上销售平台整体数据运营效率。 \r\n2.根据实时数据反馈，制定相应完善数据平台能力，驱动业务效率提升。 \r\n3. 理解数据分析应用场景并抽象为数据产品需求，制定数据模型的产品化策略，推动数据产品的落地；\r\n任职资格： \r\n1.本科及以上学历，5年以上数据分析及产品设计相关经验，参与过基金、券商等金融机构的数据服务相关系统建设的优先。 \r\n2.熟悉统计学理论，熟练常用统计方法，建立分析模型。熟练使用SQL等工具，能够独立完成数据探查输出分析结果，高效使用逻辑与数据有效沟通。 \r\n4.良好的数据分析能力和数据敏感度，具备较强的跨团队合作，协调沟通能力，较强的内驱力，能够持续在业务方向上进行探索与尝试。 \r\n5. 参与或主导过数据体系或报表体系的搭建，有较好的业务抽象能力和系统设计能力。', '0', '[1020000, 1000160, 110101]', '京东科技控股股份有限公司', '302f3d54-0c50-409d-991a-45ebb0f971a7', '北京市北京经济技术开发区科创十一街18号C座2层221室', '1000160', '101010100', '北京市', '4', '5');
