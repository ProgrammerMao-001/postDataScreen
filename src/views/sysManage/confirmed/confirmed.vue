  ...
  <div class="main-view">
    <div class="comment-manage">
      ...
      <div class="r-content-search-box" v-show="showSearchForm">
        ...
        >
          <el-form-item size="small" label="确诊人:">
            <el-input v-model="searchForm.name"></el-input>
          </el-form-item>

          <el-form-item size="small" label="密接人:">
            <el-input v-model="searchForm.staticname"></el-input>
          </el-form-item>
      ...
      <div style="width: 97%; margin: 0 auto">
        <div class="table">
          ...
          >
            ...
            <el-table-column show-overflow-tooltip prop="name" label="确诊人" />
            <el-table-column
            ...
            >
              <template slot-scope="scope">
                <span
                  :style="
                    scope.row.namestatus === '已死亡'
                      ? 'color: lightcoral'
                      : scope.row.namestatus === '已治愈'
                      ? 'color: lightgreen'
                      : 'color: lightgray'
                  "
                >
                  {{ scope.row.namestatus }}
                </span>
              </template>
            </el-table-column>
            <!--            <el-table-column-->
            ...
            >
              <template slot-scope="scope">
                <span
                  :style="
                    scope.row.staticstatus === '已死亡'
                      ? 'color: lightcoral'
                      : scope.row.staticstatus === '已治愈'
                      ? 'color: lightgreen'
                      : 'color: lightgray'
                  "
                >
                  {{ scope.row.staticstatus }}
                </span>
              </template>
            </el-table-column>
            <!--            <el-table-column-->
...
import publicDialog from "@/views/sysManage/confirmed/publicDialog.vue";
